          ...
          {pageIdx === 0 && (
            <section className="grid grid-cols-2 gap-8 mb-10">
                <div className="p-6 rounded-[16px] space-y-2 bg-slate-50 border border-slate-100">
                    <h3 className="font-bold text-blue-600 text-[11px] uppercase">Payment From</h3>
                ...
                <div className="p-6 rounded-[16px] space-y-3 bg-amber-50/50 border border-amber-100/50">
                    ...
                    <div className="flex justify-between items-center pt-1">
                        ...
                        <p className="font-black text-orange-900 tracking-tight text-[16px]">KES {formatCurrency(totalAccountBalance)}</p>
                    </div>
                </div>
            </section>
          )}
                ...
                <div className="flex justify-between items-start gap-12">
                    ...
                    <div className="w-[300px] space-y-1.5">
                        ...
                        <div className="flex justify-between items-center p-3 bg-emerald-50 rounded-lg border border-emerald-100 my-1">
                            <span className="font-black uppercase text-emerald-800 text-[10px]">AMOUNT PAID TODAY</span>
                            <span className="font-black text-emerald-700 tracking-tight text-[16px]">KES {formatCurrency(amountPaidToday)}</span>
                        </div>
                        <div className="h-0.5 w-full bg-black" />
                        <div className="flex justify-between items-center py-4 mt-2">
                            <span className="text-[12px] font-black uppercase text-blue-900">TOTAL ACCOUNT DEBT</span>
                            <span className="font-black text-blue-900 tracking-tight text-[20px]">KES {formatCurrency(totalAccountBalance)}</span>
                        </div>
                    </div>
                </div>
            </div>
