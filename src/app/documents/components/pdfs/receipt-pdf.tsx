      ...
      <header className="flex justify-between items-start mb-6">
        <div className="space-y-3">
            ...
            <div className="space-y-0.5 text-[11px] font-medium text-black">
                <p><span className="w-24 inline-block opacity-60">Receipt No</span> <span className="font-bold">{workspace?.receiptPrefix || 'RCT'}{receiptNo}</span></p>
                <p><span className="w-24 inline-block opacity-60">Receipt Date</span> <span className="font-bold">{format(new Date(docSnapshot.generatedDate), "MMM dd, yyyy")}</span></p>
            </div>
        </div>
                ...
                {items?.map((item: SaleItem, idx: number) => {
                    ...
                    return (
                        <tr key={idx} className="border-b border-gray-100">
                            ...
                            <td className="py-3 text-right text-[10px] font-medium">KES {formatCurrency(item.price)}</td>
        ...
        <div className="flex justify-between items-start mt-6">
            ...
            <div className="w-[280px] space-y-3">
                ...
                <div className="pt-3 border-t-2 border-black flex justify-between items-center">
                    ...
                    <span className="text-[16px] font-bold">KES {formatCurrency(amount)}</span>
                </div>
