 ...
 * Designed to match the Invoice and Quotation layout style.
 */
          ...
          {pageIdx === 0 ? (
            <header className="flex justify-between items-start mb-4 pb-2 border-b">
                ...
                <div className="text-right w-[45%] space-y-0.5">
                    ...
                    <div className="pt-1">
                        <p className="text-[10px] font-black uppercase" style={{ color: primaryBlue }}>PROFORMA NO: #{proformaNo}</p>
            ...
            <div className="mb-4 border-b pb-2 flex justify-between items-end">
                <p className="text-[10px] font-black uppercase opacity-40 tracking-widest text-black">Proforma Continued: #{proformaNo}</p>
          ...
          {pageIdx === 0 && (
            <div className="grid grid-cols-[60%_40%] gap-0 mb-4 border-b pb-4">
                ...
                <div className="bg-blue-50/40 p-4 flex flex-col justify-center border-l border-black/5 rounded-r-lg">
                    <p className="text-[9px] font-black text-black uppercase tracking-widest mb-1">Total Proforma Value</p>
                    <div className="pb-2">
                    ...
                    <div className="mt-1 pt-2 border-t border-blue-200">
                        <p className="text-[8px] font-bold uppercase tracking-tight text-black">Status: <span className="font-black">PAYMENT CONFIRMATION PENDING</span></p>
                    </div>
                </div>
            </div>
          )}
                    ...
                    <div className="flex justify-between items-start gap-8">
                        <div className="flex-1 space-y-3">
                            <div className="p-3 bg-slate-50 border rounded-lg">
                                <p className="text-[7px] font-black uppercase text-blue-900/40 tracking-widest mb-1">Proforma Notice</p>
                        ...
                        <div className="w-[300px] space-y-0">
                            <div className="flex justify-between items-center p-2.5 bg-slate-50/50 border-b border-white">
                                <span className="font-bold text-black opacity-40 uppercase text-[8px]">Net Subtotal</span>
