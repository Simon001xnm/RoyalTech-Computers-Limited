          ...
          {pageIdx === 0 ? (
            <header className="flex justify-between items-start mb-6 pb-6 border-b">
                ...
                <div className="text-right w-[28%] space-y-1">
                    ...
                    <div className="pt-2">
                        <p className="text-[12px] font-black uppercase" style={{ color: primaryBlue }}>PROFORMA NO: #{proformaNo}</p>
            ...
            <div className="mb-6 border-b pb-4 flex justify-between items-end">
                <p className="text-[12px] font-black uppercase opacity-40 tracking-widest text-black">Proforma Continued: #{proformaNo}</p>
          ...
          {pageIdx === 0 && (
            <div className="grid grid-cols-[60%_40%] gap-0 mb-6 border-b pb-6">
                ...
                <div className="bg-blue-50/40 p-5 flex flex-col justify-center border-l border-black/5 rounded-r-xl">
                    <p className="text-[11px] font-black text-black uppercase tracking-widest mb-2">Total Proforma Value</p>
                    <div className="pb-3">
                    ...
                    <div className="mt-2 pt-3 border-t border-blue-200">
                        <p className="text-[10px] font-bold uppercase tracking-tight text-black">Status: <span className="font-black">PAYMENT CONFIRMATION PENDING</span></p>
                    </div>
                </div>
            </div>
          )}
                    ...
                    <div className="flex justify-between items-start gap-12">
                        <div className="flex-1 space-y-4">
                            <div className="p-4 bg-slate-50 border rounded-xl">
                                <p className="text-[9px] font-black uppercase text-blue-900/40 tracking-widest mb-1.5">Proforma Notice</p>
