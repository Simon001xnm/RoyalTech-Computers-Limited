            ...
            <>
              <header className="flex justify-between items-start mb-6">
                  ...
                  <div className="flex flex-col items-center justify-center text-center w-1/3 pt-4">
                      ...
                      <p className="font-bold text-[12px] uppercase tracking-wide mt-1" style={{ color: primaryGreen }}>Official Tax Invoice</p>
                  </div>
                  <div className="text-right w-1/3 space-y-0.5">
                      ...
                      <div className="pt-3">
                          <p className="text-[13px] font-black uppercase" style={{ color: primaryBlue }}>INVOICE NO: {invoiceNo}</p>
          ...
          {pageIdx === 0 && (
            <section className="grid grid-cols-2 gap-8 mb-10">
                <div className="p-6 rounded-[20px] space-y-2 bg-[#F4F7FF]">
                    <h3 className="font-bold text-blue-600 text-[14px]">Billing To</h3>
                ...
                <div className="p-6 rounded-[20px] space-y-3 bg-[#FFFBF0]">
                    ...
                    <div className="flex justify-between items-center pt-1">
                        ...
                        <p className="font-black text-orange-900 tracking-tighter text-[22px]">KES {formatCurrency(totalAmountDue)}</p>
                    </div>
                </div>
            </section>
          )}
                ...
                <div className="flex justify-between items-start gap-12">
                    ...
                    <div className="w-[380px] space-y-2">
                        ...
                        <div className="flex justify-between items-center py-2 text-[13px]">
                            ...
                            <span className="font-black">{formatCurrency(vat)}</span>
                        </div>
                        <div className="h-0.5 w-full bg-black" />
                        <div className="flex justify-between items-center py-2 text-[14px] bg-slate-50 px-2 rounded">
                        ...
                        <div className="flex justify-between items-center py-6 mt-4">
                            ...
                            <span className="font-black text-blue-900 tracking-tighter text-[28px]">KES {formatCurrency(totalAmountDue)}</span>
                        </div>
                    </div>
                </div>
            </div>
