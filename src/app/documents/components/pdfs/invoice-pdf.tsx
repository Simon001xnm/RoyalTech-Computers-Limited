 ...
 * Updated with larger company name and recalibrated pagination.
 */

// CALIBRATED HEIGHT CONSTANTS (Pixels) - Updated for larger fonts
        ...
        >
          {pageIdx === 0 ? (
            ...
            <div className="mb-6 border-b pb-4 flex justify-between items-end">
                <p className="text-[12px] font-black uppercase opacity-40 tracking-widest text-black">Invoice Continued: #{invoiceNo}</p>
          ...
          {pageIdx === 0 && (
            <div className="grid grid-cols-[60%_40%] gap-0 mb-6 border-b pb-6">
                ...
                <div className="bg-blue-50/40 p-5 flex flex-col justify-center border-l border-black/5 rounded-r-xl">
                    <p className="text-[11px] font-black text-black uppercase tracking-widest mb-2">Net Balance Due</p>
                    <div className="pb-3">
                    ...
                    <div className="flex justify-between items-start gap-12">
                        <div className="flex-1 space-y-4">
                            <div className="p-4 bg-slate-50 border rounded-xl">
                                <p className="text-[9px] font-black uppercase text-blue-900/40 tracking-widest mb-1.5">Invoice Terms</p>
                        ...
                        <div className="w-[350px] space-y-0">
                            <div className="flex justify-between items-center p-3 bg-slate-50/50 border-b border-white">
                                <span className="font-bold text-black opacity-50 uppercase text-[10px]">Invoice Subtotal</span>
                            ...
                            <div className="flex justify-between items-center p-3 bg-orange-50/30 border-b border-white">
                                <span className="font-bold text-orange-800/60 uppercase text-[10px]">Brought Forward</span>
                                <span className="font-black text-orange-800 text-[12px]">{formatCurrency(previousBalance)}</span>
                            </div>
                            <div className="flex justify-between items-center p-5 bg-blue-900 text-white shadow-xl mt-1 rounded-sm">
                                <span className="text-[13px] font-black uppercase tracking-tighter">Net Amount Due</span>
