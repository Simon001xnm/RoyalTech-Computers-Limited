    ...
    <div className="flex flex-col items-center gap-6 bg-slate-100 p-8">
      {pages.map((pageItems, pageIdx) => (
        ...
        >
            ...
            <>
              <header className="flex justify-between items-start mb-6">
                  ...
                  <div className="flex flex-col items-center justify-center text-center flex-1 pt-4 px-4 overflow-hidden">
                      ...
                      <p className="font-medium text-[10px] uppercase tracking-wide mt-1" style={{ color: primaryGreen }}>Official Tax Invoice</p>
                  </div>
                  <div className="text-right w-1/4 space-y-0.5">
                      ...
                      <div className="pt-3">
                          <p className="text-[11px] font-medium uppercase" style={{ color: primaryBlue }}>INVOICE NO: {invoiceNo}</p>
          ...
          {pageIdx === 0 && (
            <section className="grid grid-cols-2 gap-8 mb-10">
                <div className="p-6 rounded-[16px] space-y-2 bg-slate-50 border border-slate-100">
                    <h3 className="font-medium text-blue-600 text-[11px] uppercase">Billing To</h3>
                ...
                <div className="p-6 rounded-[16px] space-y-3 bg-amber-50/50 border border-amber-100/50">
                    ...
                    <div className="flex justify-between items-center pt-1">
                        ...
                        <p className="font-medium text-orange-900 tracking-tight text-[16px]">KES {formatCurrency(totalAmountDue)}</p>
                    </div>
                </div>
            </section>
          )}
          ...
          {pageIdx > 0 && (
            <div className="mb-6">
                <p className="text-[9px] font-medium uppercase opacity-40 tracking-widest">Invoice Continued: {invoiceNo} - Page {pageIdx + 1}</p>
            </div>
          )}
                ...
                <div className="flex justify-between items-start gap-12">
                    ...
                    <div className="w-[300px] space-y-1.5">
                        ...
                        <div className="flex justify-between items-center py-1 text-[10px]">
                            ...
                            <span className="font-normal">{formatCurrency(vat)}</span>
                        </div>
                        ...
                        <div className="flex justify-between items-center py-4 mt-2">
                            ...
                            <span className="font-medium text-blue-900 tracking-tight text-[20px]">KES {formatCurrency(totalAmountDue)}</span>
                        </div>
                    </div>
                </div>
            </div>
